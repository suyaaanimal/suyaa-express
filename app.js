...
app.get("/testdata", (req, res) => {
  ...
  res.send({
    ...
    data: {
      totalScore: [
        // efficiency
        { dateTime: DateTime(2022, 6, 29), score: 20 },
        { dateTime: DateTime(2022, 6, 30), score: 30 },
        { dateTime: DateTime(2022, 7, 1), score: 40 },
      ],
      levels: [
        ...
        { dateTime: DateTime(2022, 6, 30, 23, 0), level: 0 }, // level: wake
        { dateTime: DateTime(2022, 6, 30, 23, 30), level: 1 }, //level: rem
        { dateTime: DateTime(2022, 7, 1, 0, 0), level: 1 },
      ],
    },
  });
});
